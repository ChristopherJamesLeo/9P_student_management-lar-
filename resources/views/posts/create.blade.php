                    ...
                    <div class="row">
                        <div class=" col-md-4 col-sm-12 mb-2">
                            <div class="form-group">
                                {{-- hidden area --}}
                                <input type="hidden" name="dayable_type" value="App\Models\Day">
                                <input type="file" name="image" id="coverphotos" class="form-control d-none" />
                                {{-- end hidden area --}}
                        ...
                        <div class=" col-md-8 col-sm-12">
                            <div class="row">
                                <div class="col-12 mb-2 form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control rounded-0 shadow-none outline-none " value="{{old("name")}}" placeholder="Title">
                                </div>
                                ...
                                <div class="col-12 col-md-4 mb-2 form-group">
                                    ...
                                    <select name="type_id" id="type_id" class="form-select rounded-0 shadow-none outline-none">
...
<script>
    $(document).ready(function(){
        ...
        // start type change 
        let getFee = document.querySelector("#fee");
        let getType = document.querySelector("#type_id");
        getType.value = 1;
        getFee.addEventListener("change",function(){
            if(getFee.value){
                getType.value = 2;
            }else {
                getType.value = 1;
